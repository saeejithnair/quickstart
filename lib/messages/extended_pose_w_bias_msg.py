"""Auto-generated MQTT message class from TOML configuration config/bot_quickstart_msgs.toml at 2025-01-26 15:08:55.893184."""
...
class EXTENDED_POSE_W_BIAS_MSG(MqttMessageBase):
    """MQTT message class for EXTENDED_POSE_W_BIAS."""
    ...
    def __init__(self, timestamp: float | None = None, r_a_b_x: float | None = None, r_a_b_y: float | None = None, r_a_b_z: float | None = None, v_a_b_x: float | None = None, v_a_b_y: float | None = None, v_a_b_z: float | None = None, phi_a_b_x: float | None = None, phi_a_b_y: float | None = None, phi_a_b_z: float | None = None, bias_gyro_x: float | None = None, bias_gyro_y: float | None = None, bias_gyro_z: float | None = None, bias_accel_x: float | None = None, bias_accel_y: float | None = None, bias_accel_z: float | None = None):
