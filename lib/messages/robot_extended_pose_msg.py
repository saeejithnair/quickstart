"""Auto-generated MQTT message class from TOML configuration config/bot_quickstart_msgs.toml at 2025-01-31 16:35:41.259304."""
...
class ROBOT_EXTENDED_POSE_MSG(MqttMessageBase):
    """MQTT message class for ROBOT_EXTENDED_POSE."""
    ...
    def __init__(self, timestamp: float | None = None, r_a_b_x_m: float | None = None, r_a_b_y_m: float | None = None, r_a_b_z_m: float | None = None, v_a_b_x_mps: float | None = None, v_a_b_y_mps: float | None = None, v_a_b_z_mps: float | None = None, phi_a_b_x_rad: float | None = None, phi_a_b_y_rad: float | None = None, phi_a_b_z_rad: float | None = None):
