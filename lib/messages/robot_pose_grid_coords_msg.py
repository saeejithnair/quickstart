"""Auto-generated MQTT message class from TOML configuration config/bot_quickstart_msgs.toml at 2025-01-31 01:02:13.376617."""
...
class ROBOT_POSE_GRID_COORDS_MSG(MqttMessageBase):
    """MQTT message class for ROBOT_POSE_GRID_COORDS."""
    ...
    def __init__(self, timestamp: float | None = None, x_grid: int | None = None, theta_rad: float | None = None, y_grid: int | None = None):
