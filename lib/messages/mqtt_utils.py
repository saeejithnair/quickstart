...
class MQTTPublisher:
    ...
    def __init__(self, broker_address="localhost", topic_to_message_map: dict[str, MqttMessageBase] | None = None):
        """
    ...
    def connect(self, keep_alive: int | None = None):
    ...
    def publish_dict(self, topic, data: dict | None = None):
        """
        ...
        _msg_info = self.client.publish(topic, payload)
    ...
    def publish_msg(self, topic, msg: MqttMessageBase | None = None):
        """
    ...
    def run(self, keep_alive: int | None = None):
...
class MQTTSubscriber(Thread):
    ...
    def on_connect(self, client, userdata, flags, rc, properties):
        ...
        for topic in self.topic_to_message_map:
