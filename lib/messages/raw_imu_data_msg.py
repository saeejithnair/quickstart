"""Auto-generated MQTT message class from TOML configuration config/bot_quickstart_msgs.toml at 2025-01-31 01:02:13.367153."""
...
class RAW_IMU_DATA_MSG(MqttMessageBase):
    """MQTT message class for RAW_IMU_DATA."""
    ...
    def __init__(self, timestamp: float | None = None, accel_x: float | None = None, accel_y: float | None = None, accel_z: float | None = None, gyro_x: float | None = None, gyro_y: float | None = None, gyro_z: float | None = None):
